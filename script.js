...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderStatistics(hits, faults, total) {
        ...
        const cards = [
            { title: 'Page Hits', value: hits, rate: `${hitRate}%`, type: 'hit', ...getCardStyles('blue') },
            { title: 'Page Faults', value: faults, rate: `${faultRate}%`, type: 'fault', ...getCardStyles('red') },
            { title: 'Total References', value: total, rate: ``, type: 'total', ...getCardStyles('violet') },
    ...
    function getCardStyles(color) {
        // Updated to a lighter, more modern pastel color palette
        const styleMap = {
            blue:    { icon: `<svg class="w-8 h-8 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>`, bgColor: 'bg-blue-50', textColor: 'text-blue-800', rateColor: 'text-blue-600', borderColor: 'border-blue-200/80' },
            ...
            violet:  { icon: `<svg class="w-8 h-8 text-violet-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9.75M10.5 12h9.75M10.5 18h9.75M3.75 6H7.5v1.5H3.75V6Zm0 6H7.5v1.5H3.75V12Zm0 6H7.5v1.5H3.75V18Z" /></svg>`, bgColor: 'bg-violet-50', textColor: 'text-violet-800', rateColor: 'text-violet-600', borderColor: 'border-violet-200/80' },
            slate:   { icon: `<svg class="w-8 h-8 text-slate-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" /></svg>`, bgColor: 'bg-slate-100', textColor: 'text-slate-800', rateColor: 'text-slate-600', borderColor: 'border-slate-200/80' }
        };
